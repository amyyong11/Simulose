...
function CasePlayer() {
    ...
    const doctorMood = getDoctorMoodFromScore(feedback?.score);
...
_s(CasePlayer, "A4EY6hb4p5gjH6ARpvkfp3h61nI=");
_c = CasePlayer;
...
function buildDoctorPromptText({ mode, selectedDrugName, feedbackScore }) {
    if (mode === "browse") {
